 ...
 <body>
   <div class="container">
     <div class="form-container">
       <h1 class="form-title">Ajouter line Facture :</h1>
       <form method="POST" action="{{route('saveajouterLine',$facture_id)}}" >
            @csrf
            <div>
                <h4>Ligne de facture</h4>
                <div class="mb-3">
                    <label for="facture_id" class="form-label">facture_id : </label>
                    <input type="text" name="facture_id"  class="form-control" value="{{$facture_id}}"  placeholder="Entre-facture_id" disabled>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="qte"  class="form-control" id="qte" placeholder="Entre-qte">
                </div>
            </div>
            <ul class="ul">
                <li>
